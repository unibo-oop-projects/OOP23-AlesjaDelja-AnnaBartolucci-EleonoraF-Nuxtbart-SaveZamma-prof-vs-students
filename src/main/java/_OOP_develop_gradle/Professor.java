...
public class Professor {
	 ...
	 * healthPoints; if (this.healthPoints <= 0) { removeProfessorFromGrid(); } }
	 */
	 ...
	 * 
	 * @param currentHP Updates plants health points or the current hit count
	 */
	 ...
	 */
	/*
	 * public void setxPos(int xPos) { if (xPos >= 0 && xPos <= 8) { this.xPos =
	 * xPos; } }
	 * 
	 *//**
		 * @param yPos set y to this position
		 *//*
			 * public void setyPos(int yPos) { if (yPos >= 0 && yPos <= 4) { this.yPos =
			 * yPos; } }
			 */
